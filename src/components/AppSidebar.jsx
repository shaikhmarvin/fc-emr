    ...
    Dashboard
          ...
          {userRole === "undergraduate" && (
            <button
              ...
              className={`w-full rounded-lg px-4 py-3 text-left ${activeView === "undergrad-intake"
                  ? "bg-slate-200 font-medium text-slate-900"
                  : "hover:bg-slate-100"
                }`}
            >
          ...
          {(userRole === "undergraduate" || isLeadershipView) && (
            <button
              ...
              className={`w-full rounded-lg px-4 py-3 text-left ${activeView === "registration"
                  ? "bg-slate-200 font-medium text-slate-900"
                  : "hover:bg-slate-100"
                }`}
            >
    ...
    Formulary
          ...
          {isLeadershipView && (
            <button
              ...
              className={`w-full rounded-xl px-3 py-2 text-left text-sm font-medium ${activeView === "summary"
                ? "bg-slate-900 text-white"
                : "text-slate-700 hover:bg-slate-100"
                }`}
            >
          ...
          {isLeadershipView && (
            <button
              ...
              className={`w-full rounded-xl px-3 py-2 text-left text-sm font-medium ${activeView === "programs"
                ? "bg-slate-900 text-white"
                : "text-slate-700 hover:bg-slate-100"
                }`}
            >
