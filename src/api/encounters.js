...
function mapEncounterRow(row) {
  ...
  row.leadership_intake_completed_at || null,
    ...
    refillNumber: intake.refillNumber ?? "",
    ...
    clinicEvent: intake.clinicEvent || "",
    ...
    socialWorkSeenAt: intake.socialWorkSeenAt ?? null,
    socialWorkSeenBy: intake.socialWorkSeenBy ?? null,
...
function buildIntakeData(encounter) {
  return {
    ...
    clinicEvent: encounter.clinicEvent || "",
    ...
    socialWorkSeen: encounter.socialWorkSeen ?? false,
    socialWorkSeenAt: encounter.socialWorkSeenAt ?? null,
    socialWorkSeenBy: encounter.socialWorkSeenBy ?? null,
...
export async function updateEncounterInSupabase(encounterId, updates, conditions = {}) {
  ...
  if (hasIntakeUpdates) {
    ...
    payload.intake_data = {
      ...
      refillNumber: updates.refillNumber ?? currentIntake.refillNumber ?? "",
      ...
      clinicEvent: updates.clinicEvent ?? currentIntake.clinicEvent ?? "",
      ...
      socialWorkSeen:
        updates.socialWorkSeen ?? currentIntake.socialWorkSeen ?? false,
      socialWorkSeenAt:
        updates.socialWorkSeenAt ?? currentIntake.socialWorkSeenAt ?? null,
      socialWorkSeenBy:
        updates.socialWorkSeenBy ?? currentIntake.socialWorkSeenBy ?? null,
