  ...
  const clinicNumberFields = [
    {
      ...
      autoValue: autoRefillPatientCount,
    },
    {
      label: "LWOBS",
      key: "lwobsCount",
  ...
  Export to Word
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {clinicNumberFields.map(({ label, key, helper, autoValue }) => (
              <div key={key}>
